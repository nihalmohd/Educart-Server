...
exports.AdminHideBanner = void 0;
...
const AdminHideBanner = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { _id } = req.body;
        const BlockedBanner = yield (0, AdminBannerManagment_1.HideBanner)(BannerRepository)(_id);
        if (BlockedBanner) {
...
exports.AdminHideBanner = AdminHideBanner;
