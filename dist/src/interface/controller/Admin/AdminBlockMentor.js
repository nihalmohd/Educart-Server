...
const BlockMentorReq = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const { _id } = req.body;
    console.log(_id, "UserId  kittiiiiiiiiii");
    try {
        const BlockedUser = yield (0, AdminUserManagment_1.BlockUser)(MentorRepository)(_id);
...
exports.BlockMentorReq = BlockMentorReq;
